...
class FeedbacksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create feedback" do
    assert_difference('Feedback.count') do
      post feedbacks_url, params: { feedback: { title: @feedback.title, username: @feedback.username } }
    end
  ...
  test "should update feedback" do
    patch feedback_url(@feedback), params: { feedback: { title: @feedback.title, username: @feedback.username } }
